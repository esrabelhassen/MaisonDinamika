      ...
      {orders.length === 0 ? (
        <div className="mt-8">
          ...
          <Link
            ...
            className="mt-4 inline-block rounded-full bg-ink px-7 py-3 text-sm text-paper transition-colors hover:bg-glaze-deep motion-reduce:transition-none"
          >
            {nav.voirLesProduits}
          </Link>
        </div>
            ...
            return (
              <li key={order.id}>
                <Link
                  ...
                  className="flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-glaze-light p-5 transition-colors hover:border-glaze motion-reduce:transition-none"
                >
                  <div>
