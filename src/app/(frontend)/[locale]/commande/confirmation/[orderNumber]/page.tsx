  ...
  return (
    <div className="mx-auto max-w-2xl px-6 py-20 sm:py-24">
      ...
      <Link
        ...
        className="mt-8 inline-block rounded-full border border-glaze bg-transparent px-7 py-3 text-sm uppercase tracking-[0.08em] text-ink transition-all duration-300 hover:bg-glaze hover:text-paper hover:shadow-[0_10px_28px_-12px_rgba(114,88,34,0.5)] motion-reduce:transition-none"
      >
        {nav.voirLesProduits}
      </Link>
    </div>
