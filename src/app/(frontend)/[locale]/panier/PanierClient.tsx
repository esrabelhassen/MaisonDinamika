    ...
    return (
      <div className="mx-auto max-w-3xl px-6 py-24 text-center">
        ...
        <Link
          ...
          className="mt-6 inline-block rounded-full border border-glaze bg-transparent px-7 py-3 text-sm uppercase tracking-[0.08em] text-ink transition-all duration-300 hover:bg-glaze hover:text-paper hover:shadow-[0_10px_28px_-12px_rgba(114,88,34,0.5)] motion-reduce:transition-none"
        >
          {nav.voirLesProduits}
        </Link>
      </div>
      ...
      <div className="mt-10 ms-auto flex max-w-sm flex-col gap-4 rounded-2xl border border-line bg-surface/40 p-7">
        <div>
          ...
          <select
            ...
            className="mt-1.5 w-full rounded-lg border border-line bg-paper/60 px-4 py-2.5 text-ink transition-all duration-300 focus:border-glaze focus:shadow-[0_0_0_3px_rgba(114,88,34,0.15)] motion-reduce:transition-none"
          >
            <option value="">—</option>
        ...
        <Link
          href={checkoutHref}
          className="mt-2 rounded-full border border-glaze bg-transparent px-7 py-3 text-center text-sm uppercase tracking-[0.08em] text-ink transition-all duration-300 hover:bg-glaze hover:text-paper hover:shadow-[0_10px_28px_-12px_rgba(114,88,34,0.5)] motion-reduce:transition-none"
        >
