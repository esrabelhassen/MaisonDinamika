    ...
    <div className="flex flex-col gap-6">
      ...
      {editingIndex === null ? (
        <button
          type="button"
          onClick={openAdd}
          className="self-start rounded-full border border-glaze bg-transparent px-6 py-2.5 text-sm uppercase tracking-[0.08em] text-ink transition-all duration-300 hover:bg-glaze hover:text-paper hover:shadow-[0_10px_28px_-12px_rgba(114,88,34,0.5)] motion-reduce:transition-none"
        >
        ...
        <div className="rounded-2xl border border-line bg-surface/40 p-6">
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <select
                ...
                className="rounded-lg border border-line bg-paper/60 px-4 py-2.5 text-ink transition-all duration-300 focus:border-glaze focus:shadow-[0_0_0_3px_rgba(114,88,34,0.15)] disabled:opacity-60 motion-reduce:transition-none"
              >
                <option value="">—</option>
                {governorates.map((g) => (
          ...
          <div className="mt-4 flex gap-3">
            <button
              ...
              onClick={handleSave}
              disabled={submitting}
              className="rounded-full border border-glaze bg-transparent px-6 py-2.5 text-sm uppercase tracking-[0.08em] text-ink transition-all duration-300 hover:bg-glaze hover:text-paper hover:shadow-[0_10px_28px_-12px_rgba(114,88,34,0.5)] disabled:cursor-not-allowed disabled:opacity-60 motion-reduce:transition-none"
            >
