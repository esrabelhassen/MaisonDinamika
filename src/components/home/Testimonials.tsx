    ...
    <section className="px-6 py-20 sm:py-24">
      ...
      <div className="mx-auto mt-12 grid max-w-6xl grid-cols-1 gap-6 sm:grid-cols-3">
        {REVIEWS.map((review) => (
          <figure
            key={review.name}
            className="flex flex-col rounded-2xl border border-line bg-paper/80 p-8 shadow-sm backdrop-blur-sm transition-all duration-500 hover:-translate-y-1 hover:border-glaze/40 hover:shadow-[0_24px_50px_-24px_rgba(114,88,34,0.5)] motion-reduce:transition-none motion-reduce:hover:translate-y-0"
          >
            <Stars />
