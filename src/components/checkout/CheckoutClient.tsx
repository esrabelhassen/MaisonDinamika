        ...
        <div role="alert" className="mt-6 rounded-lg border border-rim-brown/30 bg-rim-brown/10 px-4 py-3 text-sm text-rim-brown">
          ...
          {!reviewed && (
            <button
              ...
              className="mt-3 rounded-full border border-glaze bg-transparent px-5 py-2 text-xs uppercase tracking-[0.08em] text-ink transition-all duration-300 hover:bg-glaze hover:text-paper hover:shadow-[0_10px_28px_-12px_rgba(114,88,34,0.5)]"
            >
              {nav.jaiVuContinuer}
            </button>
          )}
